// code from https://www.youtube.com/watch?v=qCS0HSf3I1o&list=PLcIyXLwiPilVhgOKl2uNawwBA6KV9NLYn&index (StarkNet Basecamp - Cohort 1, Session 2)
...
// cairo-compile felt.cairo --output felts_compiled2.json
// cairo-run --program felts_compiled2.json --print_output --layout=small
